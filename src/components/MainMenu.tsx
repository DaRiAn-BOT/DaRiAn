...
const labels = {
  ru: { eyebrow: 'ТАЙНЫ ЛАБИРИНТА', title: 'Путь ждёт тебя', description: `Ты уснул дома, но во сне провалился в древний лабиринт пяти миров. Тёмная Корона подчинила его стражей и запечатала дорогу домой. Найди ${TOTAL_LEVELS} частей утраченной памяти, освободи стражей и раскрой тайну Короны.`, continue: 'Исследовать дальше', explore: 'Исследовать лабиринт', achievements: 'Достижения', stats: 'Статистика', settings: 'Настройки', account: 'Войти / регистрация', accountReady: 'Аккаунт ✓', confirm: 'Начать новое исследование?', warning: 'Текущее сохранение будет удалено. Это действие нельзя отменить.', cancel: 'Отмена', erase: 'Удалить и исследовать' },
  en: { eyebrow: 'SECRETS OF THE MAZE', title: 'The path awaits', description: `You fell asleep at home and fell into an ancient maze of five worlds. The Dark Crown enslaved its guardians and sealed the road home. Find ${TOTAL_LEVELS} fragments of lost memory, free the guardians and uncover the Crown's secret.`, continue: 'Explore further', explore: 'Explore the maze', achievements: 'Achievements', stats: 'Statistics', settings: 'Settings', account: 'Sign in / register', accountReady: 'Account ✓', confirm: 'Start a new exploration?', warning: 'Your current save will be deleted. This cannot be undone.', cancel: 'Cancel', erase: 'Delete and explore' },
  kk: { eyebrow: 'ЛАБИРИНТ ҚҰПИЯЛАРЫ', title: 'Жол сені күтеді', description: `Сен үйде ұйықтап, түсіңде бес әлемнен тұратын ежелгі лабиринтке құладың. Қара Тәж сақшыларды бағындырып, үйге апарар жолды жапты. Жоғалған жадтың ${TOTAL_LEVELS} бөлігін тауып, сақшыларды босат және Тәждің құпиясын аш.`, continue: 'Әрі қарай зерттеу', explore: 'Лабиринтті зерттеу', achievements: 'Жетістіктер', stats: 'Статистика', settings: 'Баптаулар', account: 'Кіру / тіркелу', accountReady: 'Аккаунт ✓', confirm: 'Жаңа зерттеуді бастау керек пе?', warning: 'Ағымдағы сақтау жойылады. Бұл әрекетті қайтару мүмкін емес.', cancel: 'Бас тарту', erase: 'Жою және зерттеу' },
}
