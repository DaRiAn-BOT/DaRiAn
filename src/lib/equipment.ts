export const weapons = [
  ...
  { name: 'Клинок Расколотой Печати', effect: '+2 урона к каждому удару.' },
]
...
export const shields = [
  ...
  { name: 'Щит Последнего Стража', effect: 'Блокирует 7 урона, контрудар 2,5.' },
]
...
export const armors = [
  ...
  { name: 'Латы Забытой Клятвы', effect: 'Уменьшают урон босса на 3.' },
]
